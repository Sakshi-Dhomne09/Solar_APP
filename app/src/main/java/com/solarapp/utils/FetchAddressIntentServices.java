...
public class FetchAddressIntentServices extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (intent != null) {
            String errormessgae = "";
            resultReceiver = intent.getParcelableExtra(Constants2.RECEVIER);
            Location location = intent.getParcelableExtra(Constants2.LOCATION_DATA_EXTRA);
            if (location == null) {
                return;
            }
            ...
            if (addresses == null || addresses.size() == 0) {
                ...
                devliverResultToRecevier(Constants2.SUCCESS_RESULT, str_address, str_locality, str_district, str_state, str_Country, str_postcode);
            }
        }
    ...
    private void devliverResultToRecevier(int resultcode, String address, String locality, String district, String state, String country, String postcode) {
        ...
        bundle.putString(Constants2.ADDRESS, address);
        bundle.putString(Constants2.LOCAITY, locality);
        bundle.putString(Constants2.DISTRICT, district);
        bundle.putString(Constants2.STATE, state);
        bundle.putString(Constants2.COUNTRY, country);
        bundle.putString(Constants2.POST_CODE, postcode);
